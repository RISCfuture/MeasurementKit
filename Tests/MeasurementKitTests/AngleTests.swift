...
struct `Angle Tests` {
  ...
  @Test(arguments: [(370.0, 10.0), (-10.0, 350.0), (0.0, 0.0), (360.0, 0.0), (-370.0, 350.0)])
  func `Normalizing brings an angle into compass range`(input: Double, expected: Double) {
    #expect(
  ...
  @Test(arguments: [(190.0, -170.0), (180.0, 180.0), (-190.0, 170.0), (0.0, 0.0), (350.0, -10.0)])
  func `Signed normalizing brings an angle into offset range`(input: Double, expected: Double) {
    #expect(
  ...
  @Test(arguments: [(-200.0, 340.0), (200.0, 20.0), (0.0, 180.0), (180.0, 0.0), (90.0, 270.0)])
  func `The reciprocal of a negative angle is still a compass course`(
    input: Double,
    expected: Double
  ) {
    #expect(
  ...
  @Test
  func `Normalizing preserves the unit it was given`() {
  ...
  @Test
  func `Rotating turns and folds back into compass range`() {
    #expect(
  ...
  @Test
  func `The trigonometric functions read an angle rather than a bare number`() {
  ...
  @Test
  func `The inverse functions answer with an angle`() {
  ...
  @Test
  func `Foundation's own trigonometric functions still resolve`() {
    #expect(sin(0.0) == 0)
    #expect(cos(0.0) == 1)
  }
}
