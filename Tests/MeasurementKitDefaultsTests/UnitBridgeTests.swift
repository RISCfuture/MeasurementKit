...
@Suite("Chosen unit storage")
struct UnitBridgeTests {

  @Test("A chosen unit round-trips through its identifier")
  func unitRoundTrips() throws {
  ...
  @Test("A unit is stored under its identifier and not its symbol")
  func identifiersAreNotSymbols() throws {
  ...
  @Test("An identifier nothing is registered under is reported rather than swallowed")
  func unknownIdentifiersAreDetectable() {
  ...
  @Test("A re-registered unit takes the newer identifier and keeps reading the older one")
  func laterRegistrationsWin() throws {
